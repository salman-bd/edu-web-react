            ...
            <form onSubmit={handleSubmit}>  
                <div className="m-auto mt-10 flex-col p-6 w-full lg:w-1/2">  
                    <div className="w-full mb-6">  
                        <h1 className="text-5xl lg:text-4xl mb-2 font-extrabold text-blue-800">Search Admit Card</h1>  
                        <p className="text-2xl lg:text-lg text-black-400">Enter your name, institution name and class to find out Admit Card</p>  
                    </div>   

                    <div className="text-3xl lg:text-lg flex w-full flex-col items-start justify-start gap-4">  
