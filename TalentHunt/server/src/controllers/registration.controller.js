...
export const registrationCtlr = asyncHandler( async (req, res) => {
    ...
    console.log("RegistrationNumber data type", typeof registrationNumber);
...
export const downloadAdmitCardCtlr = asyncHandler(async (req, res) => {
    ...
    console.log("RegistrationNumber data type when user try to download admit card", typeof registrationNumber);
    ...
    console.log("Applicant info after sharing: ", sharedApplicantinfo);
...
export const searchAdmitCardCtlr = asyncHandler(async (req, res) => {  
    ...
    console.log("Processed applicant info: ", sharedApplicantInfo);  
