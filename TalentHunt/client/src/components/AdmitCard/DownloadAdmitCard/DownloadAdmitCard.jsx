    ...
    useEffect(() => {  
        ...
        const fetchData = async () => {  
            try {  
                ...
                setError('Failed to load admit card. Please try again later.');   
            }  
        };  
        fetchData();  
    }, [registrationNumber]);  
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className="text-center flex flex-col gap-2 p-2">  
                            <div className="mx-auto">  
                                <img src={applicantData.photo} alt="Applicant" style={{ width: '210px', height: '210px' }} crossOrigin="anonymous" />  
                            </div>  
